  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4">
      <div className="w-full max-w-sm rounded-2xl border border-border bg-surface p-6 shadow-2xl">
        ...
        {err && (
          <p className="mb-4 rounded-lg border border-red-500/30 bg-red-500/10 px-3 py-2 text-xs font-medium text-red-400">
            {err}
          </p>
        )}
            ...
            <div className="p-4">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-1 rounded-lg border border-red-500/25 px-3 py-1.5 text-xs font-semibold text-red-400 transition-colors hover:border-red-500/60 hover:bg-red-500/10"
                  title="O'chirish"
                >
